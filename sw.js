const CACHE='cbum-cup-v3-3-dynamic-summary-tartan-final';
const ASSETS=['./','./index.html','./styles.css','./heritage.css','./ux.css','./v3patch.css','./live_detail.css','./reset_match.css','./v33.css','./data.js','./core1.js','./core2.js','./core3.js','./render1.js','./render2.js','./render3.js','./standings_layout.js','./ux.js','./rounds_summary.js','./v3patch.js','./live_detail.js','./reset_match.js','./live.js','./bind.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
